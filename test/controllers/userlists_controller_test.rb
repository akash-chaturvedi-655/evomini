...
class UserlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create userlist" do
    assert_difference('Userlist.count') do
      post userlists_url, params: { userlist: { receipients: @userlist.receipients, topic: @userlist.topic, user_id: @userlist.user_id } }
    end
  ...
  test "should update userlist" do
    patch userlist_url(@userlist), params: { userlist: { receipients: @userlist.receipients, topic: @userlist.topic, user_id: @userlist.user_id } }
